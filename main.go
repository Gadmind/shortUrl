...
func main() {
	...
	serverDefault.GET("/:path", router.Redirect)
	serverDefault.POST("/add", router.GenerateUrl)
	serverDefault.POST("/analysis", router.AnalysisUrl)
	serverDefault.DELETE("/delete", router.DeleteUrl)
